...
public class MetadataComponentModelValidatorTestCase extends AbstractMuleTestCase {
  ...
  @Test
  public void valid() {
    when(sourceModel.getMetadataResolverFactory()).thenReturn(new DefaultMetadataResolverFactory(MockResolver.class, emptyMap(), MockResolver.class, NullMetadataResolver.class));
  ...
  public static class MockResolver implements TypeKeysResolver, OutputTypeResolver {
    ...
    @Override public MetadataType getOutputType(MetadataContext context, Object key)
      throws MetadataResolvingException, ConnectionException {
      return null;
    }
    ...
    @Override public Set<MetadataKey> getKeys(MetadataContext context) throws MetadataResolvingException, ConnectionException {
      return null;
    }
  }
}
