...
public class ExtensionBuildingDefinitionProvider implements ComponentBuildingDefinitionProvider {
  ...
  private void registerExtensionParsers(ExtensionModel extensionModel) {
    ...
    XmlDslModel xmlDslModel = extensionModel.getXmlLanguageModel();
  ...
  private ExtensionParsingContext createParsingContext(ExtensionModel extensionModel) {
    ...
    parsingContext.setSubTypesMapping(new SubTypesMappingContainer(extensionModel.getSubTypesModel().getSubTypesMapping()));
